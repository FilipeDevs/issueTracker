...
function Sidebar() {
    ...
    return (
        <>
            ...
            <aside
                id="logo-sidebar"
                className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 shadow-md sm:rounded-lg"
                aria-label="Sidebar"
            >
                    ...
                    <ul className="space-y-3 font-medium">
                        ...
                        <li>
                            <button
                                ...
                                className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded text-xs w-auto sm:w-auto px-10 py-2 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
                            >
                                Log out
                            </button>
                        </li>
